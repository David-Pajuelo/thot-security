...
Notifica cuando una HPS ha sido rechazada
"""
...
class HPSRejectedTemplate:
    ...
    def get_template(data: EmailTemplateData) -> Dict[str, str]:
        ...
        """
        subject = f"Su solicitud HPS ha sido RECHAZADA - {data.document_number or 'N/A'}"
...
- Estado: RECHAZADA
- Motivo del rechazo: {data.additional_data.get('rejection_reason', 'No especificado') if data.additional_data else 'No especificado'}
        ...
        <div class="content">
            ...
            <div class="details">
                ...
                <ul>
                    ...
                    <li><strong>Motivo del rechazo:</strong> {data.additional_data.get('rejection_reason', 'No especificado') if data.additional_data else 'No especificado'}</li>
                </ul>
            </div>
