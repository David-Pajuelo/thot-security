#!/usr/bin/env python3
"""
Script para nueva prueba del sistema de monitorización
"""
...
def test_monitoring_retry():
    print("🔄 Iniciando nueva prueba del sistema de monitorización...")
    ...
    db = SessionLocal()
    try:
        print("📧 Iniciando monitorización manual...")
