#!/usr/bin/env python3
"""
Script para forzar el procesamiento de todos los correos
"""
...
def test_force_monitoring():
    print("🔄 Forzando procesamiento de todos los correos...")
    ...
    db = SessionLocal()
    try:
        print("📧 Forzando monitorización de últimos 3 días...")
        result = monitor.monitor_emails(db, since_days=3)
