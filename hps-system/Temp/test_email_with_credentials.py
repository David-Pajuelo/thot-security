#!/usr/bin/env python3
"""
Script para probar el envío real de emails usando las credenciales proporcionadas
"""
...
def login():
    """Hace login con las credenciales proporcionadas"""
    
    print("Haciendo login con aicoxidi@gmail.com...")
    
    login_data = {
        "email": "aicoxidi@gmail.com",
        "password": "wxnopfgcliyexyqf"
    }
...
def send_confirmation_email(token):
    ...
    try:
        ...
        if response.status_code == 200:
            result = response.json()
            print("EMAIL DE CONFIRMACION ENVIADO EXITOSAMENTE")
...
if __name__ == "__main__":
    print("Sistema de Emails HPS - Prueba con Credenciales")
    print("=" * 60)
    ...
    print("\n1. Enviando PRIMER EMAIL (confirmacion)...")
    ...
    if success1:
        ...
        input("Presiona Enter cuando hayas confirmado que llego el primer email...")
